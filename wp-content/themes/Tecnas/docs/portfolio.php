...
<body>
  <nav class='navbar navbar-expand-lg navbar-top'>
    <a class='navbar-brand' href='/'>
      <img src='assets/img/logos/tecnas_logo.png'>
    </a>
    ...
    <div class='pse-logo'>
      <img alt='PSE' src='assets/img/logos/logo-pse.png'>
    </div>
    <div class='languages'>
  ...
  <nav class='navbar navbar-expand-lg navbar-bottom'>
    ...
    <div class='collapse navbar-collapse' id='navbar'>
      <ul class='navbar-nav margin-auto'>
        <li class='nav-item'>
          <a class='nav-link' href='featured.html'>Destacados</a>
        </li>
        <li class='nav-item'>
        ...
        <li class='nav-item'>
          <a class='nav-link' href='clients.html'>Representaciones</a>
        </li>
        <li class='nav-item'>
  ...
  <div class="main-page">
    <div class="container">
      <div class="section-title">
        <h1>Colores naturales y alimentos colorantes</h1>
      </div>
      <div class="row">
        <div class="col-lg-4">
          <div class="portfolio-card">
            <a href="#">
              <img alt="Betacaroteno" src="https://statics-cuidateplus.marca.com/sites/default/files/styles/natural/public/betacarotenos.jpg?itok=YMAHak64">
        ...
        <div class="col-lg-4">
          <a href="#">
            <div class="portfolio-card">
              <img alt="Clorofilina" src="https://media.istockphoto.com/photos/cancer-preventing-green-juice-picture-id943011840?k=6&amp;m=943011840&amp;s=612x612&amp;w=0&amp;h=KBWSpbba-H3N_OVIxJXwP4MGjT_eIMEKnS8oVaMy9rU=">
              <div class="portfolio-text">
                <h4>Clorofilina</h4>
              </div>
            </div>
        ...
        <div class="col-lg-4">
          <a href="#">
            <div class="portfolio-card">
              <img alt="Curcumina" src="https://as.com/deporteyvida/imagenes/2018/01/31/portada/1517396804_859147_1517396898_noticia_normal.jpg">
              <div class="portfolio-text">
                <h4>Curcumina</h4>
              </div>
            </div>
      ...
      <ul class='footer-images'>
        <li>
          <a class='nav-link' href='/'>
            <img src='assets/img/logos/footer_1.png'>
          </a>
        </li>
        <li>
          <a class='nav-link' href='/'>
            <img src='assets/img/logos/footer_2.png'>
          </a>
        </li>
        <li>
          <a class='nav-link' href='/'>
            <img src='assets/img/logos/footer_3.png'>
          </a>
        </li>
        <li>
          <a class='nav-link' href='/'>
            <img src='assets/img/logos/footer_4.png'>
          </a>
        </li>
      </ul>
    </div>
